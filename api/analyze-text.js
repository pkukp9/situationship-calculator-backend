...

{
  ...
  "what_they_might_be_looking_for": [
    ...
    // Prefix this section with: "🔍 What They Might Be Looking For:"
  ],
  ...
  "advice": [
    ...
    // Each step should account for emotional tone and be specific (e.g., "Respond within 1 hour next time they reach out", "Mirror their vulnerability by sharing something slightly personal")
...
Do not include any extra text or formatting outside the JSON object.`
    ...
    result.what_they_might_be_looking_for = result.what_they_might_be_looking_for || [];
